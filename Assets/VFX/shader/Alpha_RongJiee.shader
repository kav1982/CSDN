...
////// Lighting:
////// Emissive:
                float4 node_1448 = _Time;
                float2 _UVon_var = lerp( (float2((_Tex_u_Speed*node_1448.g),(node_1448.g*_Tex_V_Speed))+i.uv0), (i.uv0+float2(i.uv1.b,i.uv1.a)), _UVon );
